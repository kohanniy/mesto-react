...
function PopupWithForm(props) {
  return (
      <div onClick={props.onClose} className={`popup popup_type_${props.name} ${props.isOpen ? 'popup_opened' : 'popup_closed'}`}>
        <form onClick={handlestopPropagation} onSubmit={props.onSubmit} name={props.name} className="popup__form place-form" noValidate>
